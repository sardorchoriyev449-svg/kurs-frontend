  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-zinc-900">Barcha darslar</h1>
          <p className="text-sm text-zinc-500 mt-0.5">Tizimga kiritilgan o'quv darslari va ularni boshqarish</p>
        </div>
        <div className="w-64">
          <select
            value={selectedGroup}
            onChange={(e) => setSelectedGroup(e.target.value)}
            className="w-full text-sm bg-white border border-zinc-200 rounded-xl px-3 py-2 shadow-xs"
          >
            ...
            <div key={lesson._id} className="bg-white border border-zinc-200/80 rounded-2xl p-5 shadow-xs">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm text-zinc-600 mt-1 whitespace-pre-line">{lesson.description}</p>
                </div>
